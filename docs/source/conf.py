...
import qdiffusivity  # noqa



# -- Project information -----------------------------------------------------

project = "qdiffusivity"
copyright = (
    "2026, Shern Ren Tee. "
...
htmlhelp_basename = "qdiffusivitydoc"
...
latex_documents = [
    (master_doc, "qdiffusivity.tex", "qdiffusivity Documentation",
     "qdiffusivity", "manual"),
]
...
man_pages = [
    (master_doc, "qdiffusivity", "qdiffusivity Documentation",
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, "qdiffusivity", "qdiffusivity Documentation",
     author, "qdiffusivity", "Quantile-based estimation of local diffusivities in molecular dynamics simulations of nanoconfined liquids",
     "Miscellaneous"),
]
